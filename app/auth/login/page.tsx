...
export default function LoginScreen({ navigate }: Props) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background px-5 py-8">
      {/* Logo */}
      <div className="flex flex-col items-center pt-6 pb-8">
        <BeresinAjaLogo size={56} />
        <span className="text-[#37474F] text-sm font-semibold mt-1">BeresinAja.</span>
      </div>

      {/* Title */}
      <h1 className="text-2xl font-bold text-foreground text-center mb-8">Masuk</h1>
      ...
      <div className="bg-card rounded-2xl shadow-sm border border-border p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs text-primary font-medium">Lupa password?</button>
          </div>
          <div className="flex items-center gap-2 border border-border rounded-xl px-3 py-2.5 bg-background focus-within:border-primary transition-colors">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-muted-foreground">atau masuk cepat</span>
          <div className="flex-1 h-px bg-border" />
        </div>

        {/* Google Login */}
        <button className="w-full border border-border rounded-2xl py-3 text-primary font-semibold text-sm hover:bg-accent transition-colors flex items-center justify-center gap-2">
      ...
      {/* Register Link */}
      <div className="flex-1 flex items-end justify-center pb-8 mt-8">
